...
<dspace:layout locbar="nolink" titlekey="jsp.home.title" feedData="<%= feedData %>">
    ...
    <% if (user == null) { %>
        ...
        <div class="panel panel-info" >
                <div class="panel-heading">
                    <h3 class="panel-title"><a href="https://https://ubc.ca1.qualtrics.com/jfe/form/SV_6J4ans7VBN2hpt3. "><i class="glyphicon glyphicon-open"></i>&nbsp;Survey</a></h3>
                </div>
                <div class="panel-body">
                    <p>When you have explored StatSpace, we would appreciate your opinion, via a brief <a href="https://https://ubc.ca1.qualtrics.com/jfe/form/SV_6J4ans7VBN2hpt3. ">survey</a>.<span class="glyphicon glyphicon-new-window"></span></p>
                </div>
		</div>
