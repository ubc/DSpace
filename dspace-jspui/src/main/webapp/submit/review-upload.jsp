...
%>
	                                            <a href="<%= request.getContextPath() %>/<%= downloadLink %>/<%= UIUtil.encodeBitstreamName(bitstreams[i].getName()) %>" target="_blank"><%= Utils.addEntities(bitstreams[i].getName()) %></a> - <%= Utils.addEntities(bitstreams[i].getFormatDescription()) %>
<%
