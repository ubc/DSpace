    ...
    <div class="example">
        ...
        <div class="row">  
            <div class="col-md-8">
                ...
                <div class="row">
                    <h2><a href="#jump"><span class="glyphicon glyphicon-new-window"></span> Click to check out more sample WeBWorK Questions</a></h2><br><br>
                    <div class="col-md-12">
            ...
            <div class="row">
                <h2>More sample WeBWorK Questions :</h2>
                <a id="jump"></a>
            </div>
