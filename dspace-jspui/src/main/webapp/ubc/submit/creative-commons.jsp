		...
		<div id='blurbCCLicense'>
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<p>In selecting and assigning this <em class='ccLicenseName'></em> license, you agree that this material(s) is either already licensed under or should be made available according to the terms of the license, as described in detail at <a id='ccLicenseLink' href=''></a>.</p>
