				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-group">
							<input class="form-control input-sm" type="text" id="query" name="query" value="${fn:escapeXml(queryStr)}"/>
				...
				<c:forEach items='${appliedFilters}' var='filter' varStatus='filterLoop'>
					<div class='form-group form-group-sm ${AppliedFilterClass}' id='${AppliedFilterClass}_${filterLoop.index}'>
						<span class="label label-primary">
							...
							<input type="hidden" name='filterquery' value="${fn:escapeXml(filter[2])}"/>
