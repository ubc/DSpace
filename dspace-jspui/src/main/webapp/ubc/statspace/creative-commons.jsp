...
jQuery("#licenseclass_chooser").change(function() {
	...
	// Require users to select a license by disabling the Next Step button
	// if they haven't selected a license. Luckily, the Creative Commons radio
	// buttons seem to have it's own validation mechanism, so we don't have to
