...
<dspace:layout locbar="nolink" titlekey="jsp.about.title" feedData="<%= feedData %>">
	...
	<p>This version of StatSpace allows you to explore, use and comment on resources such as web visualizations, videos, WebWorK questions and clicker questions.  We are currently working on implementing the Statspace contribution functionality for those of you who have resources to share. Please contact <a href="mailto:statspace@stat.ubc.ca">statspace@stat.ubc.ca</a> if you are interested in contributing resources.</p>
    <p>We are a Canadian website and particularly welcome submissions in English and French.  However, the curation team may not be able to thoroughly vet all resources submitted in alternative languages.</p>    
	<div class="panel panel-info" >
		...
		<div class="panel-body">
			<ul>
				...
				<li>
					Email <a href='mailto:statspace@stat.ubc.ca'>statspace@stat.ubc.ca</a> for more information about the UBC Statistics Flexible Learning project or the StatSpace project, or if you have questions about a resource that you have submitted to Statspace.
				</li>
			</ul>
		</div>
	</div>
