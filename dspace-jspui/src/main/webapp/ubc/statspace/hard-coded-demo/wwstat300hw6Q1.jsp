...
<dspace:layout locbar="nolink" titlekey="jsp.about.title" feedData="<%= feedData %>">
    ...
    <div class="example">
        ...
        <p><a href="<c:url value='/home.jsp'/>">Home</a> <span class="text-muted">&raquo;</span> <a href="<c:url value='/demo/WebWork_Questions.jsp'/>">WeBWorK Questions</a> <span class="text-muted">&raquo; WWSTAT300HW6Q1</span></p>
        ...
        <div class="row">  
            <div class="col-md-8">
                ...
                <div class="row description">
                    <div class="col-md-12">
                        <img class="pull-left zoology-fish" src="<c:url value='/image/stat300_displayimage.JPG'/>" width="500">
                    </div>
                </div>
                 <div class="row">
					 <h2><a href="<c:url value='/pdf_folder/STAT300HW6Q1.pdf'/>"><span class="glyphicon glyphicon-new-window"></span> Click to see details on this question</a></h2><br><br> 
                </div>
