...
<dspace:layout locbar="nolink" titlekey="jsp.about.title" feedData="<%= feedData %>">
    ...
    <div class="example">
        <p><a href="<c:url value='/home.jsp' />">Home</a> <span class="text-muted">&raquo;</span> <a href="<c:url value='/demo/sim-example.jsp' />">Simulation Example</a> <span class="text-muted">&raquo; Web Visualization: Sampling from a non-Normally Distributed Population(CLT)</span></p>
            ...
            <div class="col-md-8">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-8">
                            <p class="intro-text">This web visualization explores the sampling distribution of the mean when the data do not necessarily follow a Normal distribution. <br><br>
                                This visualization is designed to be used after the students are familiar with the general principles of sampling. The <a href="<c:url value='/demo/sim-example.jsp' />">Sampling from a Normal distribution<span class="glyphicon glyphicon-new-window"></span></a> visualization should be used first to introduce some of the basic concepts and the visual metaphors used here.</p><br><br>
                ...
                <div class="row details">
                    ...
                    <ul>
                        ...
                        <li>as a guided learning experience, using either the built-in tutorials, guided activity sheet (click here for <a target="_blank" href="<c:url value='/pdf_folder/Applet2InstructorGuide.pdf' />">Instructor Guide<span class="glyphicon glyphicon-new-window"></span></a> and <a target="_blank" href="<c:url value='/pdf_folder/Applet2Qs.pdf' />">Activity Sheet<span class="glyphicon glyphicon-new-window"></span>)</a>, or other instructor-supplied material.</li>
                    </ul>
            ...
            <div class="col-md-4">
                    ...
                    <div class="details tags">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <ul>
                                    ...
                                    <li>It is recommended that the “Sampling from a Normal distribution” web visualization be used first to introduce some of the basic concepts and the visual metaphors used in the CLT web visualization&colon; <a target="_blank" href="<c:url value='/demo/sim-example.jsp' />">Web Visualization: Sampling from a Normal distribution <span class="glyphicon glyphicon-new-window"></span></a></li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p>We learned a lot about this resource from trialling with students. Many students hold misconceptions related to the Central Limit Theorem. From our teaching, we have found that although students might be able to perform formal calculations, they often get confused with some of the concepts surrounding this topic.<br><a target="_blank" href="<c:url value='/demo/SampNonNorm_WhatWeLearned.jsp' />">Read More <span class="glyphicon glyphicon-new-window"></span></a></p>
                            </div>
                        </div> 
                    </div>
                </div>			
