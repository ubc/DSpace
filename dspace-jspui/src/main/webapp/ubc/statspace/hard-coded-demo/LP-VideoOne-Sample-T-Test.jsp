...
<dspace:layout locbar="nolink" titlekey="jsp.about.title" feedData="<%= feedData %>">
    ...
    <div class="example">
        <p><a href="<c:url value='/home.jsp' />">Home</a> <span class="text-muted">&raquo;</span> <a href="<c:url value='/demo/sim-example.jsp' />">Video Example</a> <span class="text-muted">&raquo; Video: One Sample T-Test</span></p>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <ul>
                                    ...
                                    <li><a href="<c:url value='/demo/iClicker-example-3-Hypothesistesting.jsp' />"><i>iClicker Questions <span class="glyphicon glyphicon-new-window"></span></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>  
