 ...
 */
package org.dspace.app.webui.ubc.submit.processing;
...
public class DescribeStep extends AbstractProcessingStep
{
            ...
            AuthorizeException
    {
		...
		// try to save related resources
		RelatedResourceManager relatedResources = new RelatedResourceManager(context, subInfo.getSubmissionItem().getItem());
		relatedResources.saveBidirectional(request);
