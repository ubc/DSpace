 ...
 * @version $Revision$
 */
public class JSPUBCLicenseStep extends JSPStep
{
    /** JSP which displays Creative Commons license information * */
    private static final String CC_LICENSE_JSP = "/ubc/submit/creative-commons.jsp";
    ...
    /** log4j logger */
    private static Logger log = Logger.getLogger(JSPUBCLicenseStep.class);
